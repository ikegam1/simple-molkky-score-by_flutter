...
void main() {
  group('Bug Fix: scoreSnapshot for correct undo after burst', () {
    ...
    test('scoreSnapshot saves pre-burst score correctly', () {
      p.currentScore = 48;
      GameLogic.processThrow(p, [
        1,
        2,
        3,
        4,
      ], match); // 48 + 4 = 52 → burst → 25
  ...
  group(
    'Bug Fix: turn counter increments correctly when player 0 is disqualified',
    () {
  ...
  group('Bug Fix: survivor scoreHistory is updated', () {
    test(
      'scoreSnapshot is saved before survivor auto-complete would be applied',
      () {
