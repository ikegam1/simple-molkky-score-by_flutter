  ...
  List<Widget> _jaSections(L10n t) => [
    ...
    const _HelpSection(
      ...
      items: [
        ...
        'iPhone・iPad はテンキーなどの外付けキーボードを繋いでいる間、画面のキーボードが出ません（iOS の仕様）。「設定」→「アクセシビリティ」→「タッチ」→「背面タップ」で「ダブルタップ」に「AssistiveTouch」を割り当てておくと、iPhone の背面を 2 回叩くだけでキーボードを呼び出せます（もう一度叩くと戻ります）',
  ...
  List<Widget> _enSections(L10n t) => [
    ...
    const _HelpSection(
      ...
      items: [
        ...
        'On iPhone/iPad the on-screen keyboard stays hidden while an external keyboard (including a numpad) is connected. Assign AssistiveTouch to Back Tap (Settings > Accessibility > Touch > Back Tap > Double Tap) and you can bring the keyboard up by tapping the back of the phone twice (tap twice again to turn it off)',
